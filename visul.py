...
nii = nib.load(r'/home/lc/学习/DataBase/kits/Test_Nii256/mask/mask0.nii')
imgs = nii.get_data()
zoom = nii.header.get_zooms()
# smooth (may loss details)
organ_1 = ndimg.gaussian_filter(np.float32(imgs==0), 1)
organ_2 = ndimg.gaussian_filter(np.float32(imgs==1), 1)

...
from dataset.dataset_fix import train_fix_ds,valid_fix_ds
...
def main():
    ...
    model = torch.nn.DataParallel(net, device_ids = [3,0 ,1,2]).to(device)
    # 定义优化器
    ...
    # 学习率衰减
    scheduler = lr_scheduler.ReduceLROnPlateau(optimizer, mode='min', factor=0.5, patience=760,
